...
routes.route("/sightings/:id?")
  ...
  .post(function (req, res) {
    Sighting.addSighting(req.body.sighting, function(err, data){
      if(err){
        ...
        res.send({message: "Have a funny day!"})
    })
  })
  ...
  .put(function (req, res) {
    Sighting.editSighting(req.params.id, req.body.sighting, function(err, numReplaced){
      ...
      res.send({message: 'thanks for updating ' + numReplaced + ' sighting details'})
    })
  })

  .delete(function (req, res) {
    Sighting.deleteSighting(req.params.id, function(err, numReplaced){
      if(err){
